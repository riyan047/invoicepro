export default function LogoSvg({ className = "" }: { className?: string }) {
    return (
        ...
        >
            ...
            <path
                d="M112 64C99.0 64 88 75.0 88 88V424C88 437.0 99.0 448 112 448H400C413.0 448 424 437.0 424 424V160L328 64H112Z"
                fill="url(#gradient)"
            />
            ...
            <path
                d="M176 336C168.27 343.73 168.27 356.27 176 364L216 404C223.73 411.73 236.27 411.73 244 404L336 312C343.73 304.27 343.73 291.73 336 284C328.27 276.27 315.73 276.27 308 284L230 362L204 336C196.27 328.27 183.73 328.27 176 336Z"
                fill="white"
            />
        </svg>
    );
